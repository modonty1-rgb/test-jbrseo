...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /admin/login (http://localhost:3000/admin/login) to access the admin login page.
        ...
        await expect(frame.locator('text=Last 7').first).to_be_visible(timeout=3000)
