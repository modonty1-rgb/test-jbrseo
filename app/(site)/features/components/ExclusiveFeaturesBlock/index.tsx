...
const features: Feature[] = [
  {
    id: "audio", num: "01", icon: "🎧", color: "violet",
    label: "نسخة صوتية لكل مقال",
    sub: "يُقرأ مقالك تلقائياً — بدون أي جهد إضافي",
    detail: "كل مقال تنشره يتحول تلقائياً لنسخة صوتية جاهزة. الزوار الذين يفضلون الاستماع يستهلكون محتواك — وهذا يرفع وقت الجلسة ويحسن إشارات SEO.",
    badge: "حصري في مدونتي",
  },
  {
    id: "trending", num: "02", icon: "📊", color: "amber",
    label: "ظهور في صفحة الرائجة",
    sub: "مقالاتك تظهر أمام كل زوار مدونتي",
    detail: "صفحة الرائجة تعرض أكثر المقالات قراءةً وتفاعلاً خلال 7 أو 14 أو 30 يوماً. مقالاتك القوية تظهر تلقائياً أمام جمهور مدونتي كله.",
    badge: "تصفية: 7 · 14 · 30 يوم",
  },
  {
    id: "reviews", num: "03", icon: "⭐", color: "amber",
    label: "تقييمات الشركة من الزوار",
    sub: "الزوار يقيّمون شركتك مباشرة على صفحتك",
    detail: "تبويب التقييمات يتيح للزوار والعملاء تقييم شركتك علناً — وهذا يبني social proof حقيقي يراه كل من يزور صفحتك.",
    badge: "social proof تلقائي",
  },
  {
    id: "followers", num: "04", icon: "👥", color: "cyan",
    label: "متابعون لشركتك",
    sub: "الزوار يتابعون صفحتك ويبقون على تواصل",
    detail: "زر المتابعة يبني جمهوراً ثابتاً متصلاً بشركتك. كل مقال جديد تنشره يصل للمتابعين تلقائياً — مثل حساب سوشال داخل مدونتي.",
    badge: "جمهور دائم",
  },
  {
    id: "verified", num: "05", icon: "✓", color: "green",
    label: "شارة موثّق",
    sub: "بادج مصداقية يظهر على صفحتك ومقالاتك",
    detail: "الشارة الزرقاء تظهر على اسم شركتك في كل مقال وعلى صفحتك — تزيد الثقة وتميّزك عن الشركات غير الموثّقة.",
    badge: "ثقة فورية",
  },
  {
    id: "reels", num: "06", icon: "🎬", color: "red",
    label: "تبويب ريلز خاص بشركتك",
    sub: "صفحة ريلز مستقلة ضمن صفحة شركتك",
    detail: "صفحتك تحتوي تبويب ريلز منفصل — يجمع كل الفيديوهات القصيرة في مكان واحد يمكن للزوار تصفحه بسهولة.",
    badge: "ضمن صفحتك",
  },
  {
    id: "map", num: "07", icon: "🗺️", color: "sky",
    label: "خريطة الموقع الجغرافي",
    sub: "موقع شركتك يظهر على الخريطة في صفحتك",
    detail: "الموقع الجغرافي يظهر تلقائياً في صفحتك — يساعد العملاء المحليين على إيجادك ويعزز ظهورك في Local SEO.",
    badge: "Local SEO تلقائي",
  },
  {
    id: "categories", num: "08", icon: "📂", color: "violet",
    label: "تصنيف مقالاتك في الفئات",
    sub: "مقالاتك تظهر في صفحات الفئات المتخصصة",
    detail: "مدونتي تصنف مقالاتك تلقائياً في فئات متخصصة — الباحثون عن هذه المواضيع يجدون مقالاتك دون أن تفعل شيئاً.",
    badge: "١٢ فئة متخصصة",
  },
];
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-muted/40 px-7 py-4">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="text-[13px] font-bold text-foreground">ميزات لا تجدها عند أي موظف</p>
              <p className="mt-0.5 text-[11px] text-muted-foreground">مدونتي بنت لك منظومة كاملة لا يمكن تكرارها بالتوظيف</p>
            </div>
          </div>
          <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3.5 py-1.5">
            <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />
            <span className="text-[11px] font-bold text-amber-800">٨ ميزات مدمجة في اشتراكك</span>
          </div>
        </div>
        ...
        >
          {features.map((f) => {
            ...
            return (
              <div
                key={f.id}
                className="relative bg-card p-5 transition-colors hover:bg-muted/30"
              >
                {/* Number watermark */}
                <span className="absolute left-4 top-3.5 text-[10px] font-bold tracking-widest text-muted-foreground/40">
                  {f.num}
                </span>
